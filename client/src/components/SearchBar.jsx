    ...
    <div className="relative w-full max-w-md" ref={searchRef}>
      <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-12 pr-10 text-slate-900 placeholder-slate-500 bg-white border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent shadow-sm"
            onFocus={() => {
      ...
      {showSuggestions && (
        <div
          ref={suggestionsRef}
          className="absolute top-full left-0 right-0 mt-1 bg-white border border-violet-200 rounded-xl shadow-lg z-50 max-h-96 overflow-y-auto"
        >
          {filteredUsers.length > 0 ? (
            ...
            <div className="p-6 text-center">
              ...
              <div className="text-sm font-medium text-slate-900 mb-1">No users found</div>
              <div className="text-xs text-slate-500">Try searching for a different name or username</div>
            </div>
          ) : null}
        </div>
      )}
