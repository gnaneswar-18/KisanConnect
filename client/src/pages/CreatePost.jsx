...
import { IoCloudUploadOutline, IoClose, IoLocationOutline, IoCubeOutline, IoPricetagOutline } from "react-icons/io5"
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-3xl font-bold text-slate-900 mb-6 flex items-center">
          <IoCubeOutline className="mr-3 h-8 w-8 text-violet-600" />
          Create New Post
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-slate-50 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="cropType" className="block text-sm font-medium text-slate-700 mb-1">
                    Crop Type *
                  </label>
                  <input
                    type="text"
          ...
          {/* Pricing & Quantity */}
          <div className="bg-slate-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-slate-800 mb-4">Pricing & Quantity</h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    className="w-full pl-8 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
                    placeholder="35"
                  />
                </div>
              </div>
              <div>
                <label htmlFor="priceUnit" className="block text-sm font-medium text-slate-700 mb-1">
                  Price Unit *
                </label>
                <select
                  id="priceUnit"
          ...
          <div className="bg-slate-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="location.state" className="block text-sm font-medium text-slate-700 mb-1">
                  State *
                </label>
                <select
                  id="location.state"
              ...
              <div>
                <label htmlFor="location.district" className="block text-sm font-medium text-slate-700 mb-1">
                  District *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="location.city" className="block text-sm font-medium text-slate-700 mb-1">
                  City *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="location.pincode" className="block text-sm font-medium text-slate-700 mb-1">
                  Pincode *
                </label>
                <input
                  type="text"
            ...
            <div className="mt-4">
              <label htmlFor="location.village" className="block text-sm font-medium text-slate-700 mb-1">
                Village *
              </label>
              <input
                type="text"
          ...
          <div className="bg-slate-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-slate-800 mb-4">Product Specifications</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="specifications.variety" className="block text-sm font-medium text-slate-700 mb-1">
                  Variety
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="specifications.harvestDate" className="block text-sm font-medium text-slate-700 mb-1">
                  Harvest Date
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="specifications.shelLife" className="block text-sm font-medium text-slate-700 mb-1">
                  Shelf Life *
                </label>
                <input
                  type="text"
          ...
          <div className="bg-slate-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-slate-800 mb-4 flex items-center">
              <IoPricetagOutline className="mr-2 h-5 w-5" />
              Tags & Options
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-6">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm font-medium text-slate-700">Organic Product</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-violet-600 focus:ring-violet-500 border-slate-300 rounded"
                  />
                  <span className="ml-2 text-sm font-medium text-slate-700">Featured Product</span>
                </label>
              </div>

              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Tags (Press Enter to add)</label>
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-slate-300 rounded-l-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
                    placeholder="Add tags (e.g., organic, fresh, local)"
                  />
                  <button
                    type="button"
                    onClick={addTag}
                    className="px-4 py-2 bg-violet-600 text-white rounded-r-lg hover:bg-violet-700"
                  >
                    Add
                  </button>
                </div>
          ...
          {/* Image Upload */}
          <div className="bg-slate-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-slate-800 mb-4">Product Images *</h2>
            ...
            >
              ...
              />
              <IoCloudUploadOutline className="h-12 w-12 text-slate-400 mx-auto mb-4" />
              <p className="text-slate-600 mb-2">Click to upload product images</p>
              <p className="text-sm text-slate-500">PNG, JPG, GIF up to 10MB each</p>
            </div>

            {previewImages.length > 0 && (
              <div className="mt-6">
                <h3 className="text-sm font-medium text-slate-700 mb-3">Image Previews ({previewImages.length})</h3>
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t">
            <button
              ...
              onClick={() => navigate("/")}
              disabled={loading}
              className="px-6 py-3 border border-slate-300 rounded-lg hover:bg-slate-50 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-8 py-3 bg-violet-600 text-white rounded-lg hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center font-medium transition-colors"
            >
              {loading ? (
                <>
                  <svg
