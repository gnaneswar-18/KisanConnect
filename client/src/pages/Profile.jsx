...
const Profile = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-sky-50 to-fuchsia-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8 border border-gray-100">
          ...
          {userProfile?.coverImage ? (
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-violet-600 via-indigo-500 to-sky-500"></div>
            )}

              {/* ✅ Loader Overlay */}
              {coverUploading && (
                <div className="absolute inset-0 bg-white/40 flex justify-center items-center z-10">
                  <div className="loader border-4 border-violet-600 rounded-full animate-spin h-10 w-10 border-t-transparent"></div>
                </div>
              )}
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-6 lg:space-y-0">
              ...
              <div className="flex flex-col md:flex-row md:items-start space-y-6 md:space-y-0 md:space-x-8">
                <div className="relative group">
                  ...
                  <div className="absolute -bottom-2 -right-2 bg-gradient-to-r from-violet-500 to-violet-600 text-white rounded-full p-3 shadow-lg">
                ...
                <div className="space-y-4 flex-1">
                  <div className="flex items-center space-x-3">
                    <span className="bg-gradient-to-r from-violet-500 to-violet-600 text-white px-4 py-2 rounded-full text-sm font-semibold capitalize shadow-lg">
                      {userProfile?.userType}
                    </span>
                    <div className="flex items-center space-x-1 text-yellow-500">
                      <span className="text-lg">⭐</span>
                      <span className="font-bold text-slate-900">{userProfile?.socialStats?.rating}</span>
                      <span className="text-slate-500 text-sm">({userProfile?.socialStats?.totalReviews})</span>
                    </div>
                  </div>

                  <p className="text-slate-700 text-lg leading-relaxed max-w-2xl">{userProfile?.bio}</p>
              ...
              <div className="lg:text-right space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button className="px-6 py-3 bg-white border-2 border-slate-200 text-slate-700 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 font-medium">
                    📤 Share Profile
                  </button>
                </div>
              </div>
              ...
              {[
                ...
                <button
                  ...
                  className={`relative py-4 px-6 font-medium text-sm transition-all duration-300 rounded-t-2xl ${
                    activeTab === tab.id
                      ? "bg-white text-violet-600 shadow-lg -mb-px border-t-2 border-violet-500"
              ...
              <form onSubmit={handleEditSubmit} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full border-2 border-slate-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all"
                    />
                  </div>
                ...
                <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="px-8 py-3 bg-gradient-to-r from-violet-600 to-violet-700 text-white rounded-xl hover:from-violet-700 hover:to-violet-800 disabled:opacity-50 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 font-medium"
                  >
